...
contract Skin is Ownable, ERC721Enumerable, AccessControl, Pausable {
     ...
     */
    function mintSkin(address _addressTo, string memory _uri) public whenNotPaused onlyRole(MANAGERMENT_ROLE) {
