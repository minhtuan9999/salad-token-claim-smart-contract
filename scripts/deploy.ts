...
async function main() {
  ...
  const shop = await Shop.deploy(treasury.address, general.address, genesis.address, reMonsterFarm.address, trainingItem.address, generalPrice,genesisPrice,farmPrice,bitPrice);
  shop.deployed();
