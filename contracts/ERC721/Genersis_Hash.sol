...
contract GenersisHash is Ownable, ERC721Enumerable, AccessControl, Pausable {
     ...
     */
    function mintGenesisHash(address _addressTo, string memory _uri) public whenNotPaused onlyRole(MANAGERMENT_ROLE) {
